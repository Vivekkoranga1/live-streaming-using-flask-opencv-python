...
url = "http://<your_ip_of_ip_webcam>/video" # for more information check my repo or you are facing any problem check my repo
#https://github.com/Vivekkoranga1/phone-camera-opencv-stream
...
def image_generator():
    while True:
        ...
        face_detected_image = image.copy() ### intializing iamge if face not detected
        ...
        for x,y,w,h in faces:
            cv2.rectangle(face_detected_image,(x,y),(x+w,y+h),(255,255,255)) #in place changing intializing image 
